...
This is the core microservice responsible for managing the loan service. It connects to a PostgreSQL database and fetches its configuration dynamically from the Spring Cloud Config Server.
...
2. Select the **LoanServiceApplication** run configuration.
