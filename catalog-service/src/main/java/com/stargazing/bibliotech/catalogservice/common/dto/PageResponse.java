package com.stargazing.bibliotech.catalogservice.common.dto;
...
@Schema(
  description = "Generic paginated response wrapper containing the data list and pagination metadata"
)
